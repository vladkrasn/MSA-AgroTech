...
Container_Boundary(F, "Farm") {  
  ...
  Container_Boundary(cams, "Cameras Service") {
    Container(camerareceiver, "Camera Relay", "Python", "Relays video feed")
  }
...
Container_Boundary(LMS, "Livestock Management System") {
  Container_Boundary(cameraservice, "Camera Analytics Service") {
  ...
  Container_Boundary(api, "API") {
    Container(analytics, "Analytics Controller", "Go", "Handles analytics")
...
Rel(camera1, camerareceiver, "Sends video feed")
Rel(camera2, camerareceiver, "Sends video feed")
Rel(camerareceiver, cameraio, "Sends video feed")
...
Rel(analytics, broker, "Sends analytical data")
Rel(analytics, analyticsdb, "Stores analytical data")
@enduml
```
<!-- diagram id="s1c3" caption: "s1c3" -->